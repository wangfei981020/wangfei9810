...
# 向 Lark 发送告警
# send_lark_card_message(webhook_url, title, card_color,content_list, mentioned_list=None):
...
def alert_text(namespace, container, value,message,alert_time):
    content_list = [
            f"**G32 resource alarm**",
