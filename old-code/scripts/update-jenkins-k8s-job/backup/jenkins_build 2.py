...
def trigger_jenkins_build(job_name, jenkins_url, jenkins_username, jenkins_api_token):
    try:
        ...
        logger.info(f"已触发 Job: {job_name}, 默认最新版本是: {selected_value}")
        return f"已触发 Job: {job_name}, 默认最新版本是: {selected_value}"
