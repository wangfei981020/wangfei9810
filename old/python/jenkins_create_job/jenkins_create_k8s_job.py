...
projects = {
    'project_name': 'g39',
    'env':'gli',
    'jenkins_gli':'https://uat-jenkins.slleisure.com',
...
# source_job_name = 'k8s-test_agent-api-backend-other-test-test' 
source_job_name = 'k8s-test_agent-api-backend-g32-test-test-curl' 
# 目标视图的名称        
# view_name = 'PPU-K8S-G35-UAT'
view_name = 'PPU-K8S-G39-GLI'
# view_name = 'G35-K8S-PROD'
# view_name = 'G32-UAT'
def get_harbor_project(project_name):
    ...
    while True:
        ...
        page += 1
    # all_repositories = ["profile-center-web-frontend"]
...
def create_jenkins_job():
    ...
    for r_n in harbor_reponame:
        ...
        config_xml = re.sub(r'proj="(.+?)"', f'proj="{project_name}-{projects['env']}"', config_xml)
        ...
        # gli 专用 
        new_job_name = f'k8s-{projects['project_name']}gli_{r_n}'
        # new_job_name = f'k8s-{projects['project_name']}_{r_n}'
        # print(new_job_name)
