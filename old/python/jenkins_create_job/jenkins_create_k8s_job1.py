...
projects = {'project_name': 'g31','env':'uat','jenkins_uat':'https://uat-jenkins.slleisure.com','jenkins_prod':'https://jk.slleisure.com'}
# 原有任务名称
...
def get_harbor_project(project_name):
    ...
    while True:
        ...
        page += 1
    all_repositories = ["g31-profile-center-web-frontend-test"]
