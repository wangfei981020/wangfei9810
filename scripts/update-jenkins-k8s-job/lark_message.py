...
def get_lark_id_from_nacos():
    ...
    data_id = 'test1.yml'  # 替换为你需要获取的配置 dataId
...
# def send_lark_card_message(webhook_url, title, card_color,content_list, status, mentioned_list=None):
def send_lark_card_message(webhook_url, title, card_color,content_list, mentioned_list=None):
    """
    发送 Lark 卡片消息
